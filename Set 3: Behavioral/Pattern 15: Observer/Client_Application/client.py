...
from ..External_Datasource.data_controller import DataController
...
# Add some visualisation that uses the dataview
...
# The hypothetical data controller updates some data
DATA_CONTROLLER.notify([1, 2, 3])

# Client now removes a local BAR_GRAPH
BAR_GRAPH_VIEW.delete()

# The hypothetical exteranl data controller updates the data again
