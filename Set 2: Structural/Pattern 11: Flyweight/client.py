...
TABLE.rows[0].columns[1].justify = 1
TABLE.rows[0].columns[2].justify = 1

TABLE.rows[1].columns[0].justify = "racadab"
TABLE.rows[1].columns[1].justify = "12345"
TABLE.rows[1].columns[2].justify = "332211"

TABLE.rows[2].columns[0].width = 15
TABLE.rows[2].columns[1].width = 15
TABLE.rows[2].columns[2].width = 15
